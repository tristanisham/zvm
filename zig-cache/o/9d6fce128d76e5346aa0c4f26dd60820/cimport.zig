...
pub const CURLOPT_LASTENTRY: c_int = 321;
...
pub const LIBCURL_VERSION = "7.86.0";
pub const LIBCURL_VERSION_MAJOR = @as(c_int, 7);
pub const LIBCURL_VERSION_MINOR = @as(c_int, 86);
pub const LIBCURL_VERSION_PATCH = @as(c_int, 0);
pub const LIBCURL_VERSION_NUM = @import("std").zig.c_translation.promoteIntLiteral(c_int, 0x075600, .hexadecimal);
pub const LIBCURL_TIMESTAMP = "2022-10-26";
