...
pub fn __cmsg_nxthdr(arg___mhdr: [*c]struct_msghdr, arg___cmsg: [*c]struct_cmsghdr) callconv(.C) [*c]struct_cmsghdr {
    ...
    __cmsg = @ptrCast([*c]struct_cmsghdr, @alignCast(@import("std").meta.alignment([*c]struct_cmsghdr), @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __cmsg)) + (((__cmsg.*.cmsg_len +% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1)))) & @bitCast(usize, ~(@sizeOf(usize) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))))));
    if ((@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __cmsg + @bitCast(usize, @intCast(isize, @as(c_int, 1))))) > (@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __mhdr.*.msg_control)) + __mhdr.*.msg_controllen)) or ((@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __cmsg)) + (((__cmsg.*.cmsg_len +% @sizeOf(usize)) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1)))) & @bitCast(usize, ~(@sizeOf(usize) -% @bitCast(c_ulong, @as(c_long, @as(c_int, 1))))))) > (@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __mhdr.*.msg_control)) + __mhdr.*.msg_controllen))) return @intToPtr([*c]struct_cmsghdr, @as(c_int, 0));
    return __cmsg;
}
...
pub inline fn recv(arg___fd: c_int, arg___buf: ?*anyopaque, arg___n: usize, arg___flags: c_int) isize {
    var __fd = arg___fd;
    var __buf = arg___buf;
    var __n = arg___n;
    var __flags = arg___flags;
    var sz: usize = __builtin_object_size(__buf, @as(c_int, 0));
    if (((__builtin_constant_p(sz) != 0) and (sz == @bitCast(c_ulong, @as(c_long, -@as(c_int, 1))))) or ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8))) != 0)) and (@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8))))) return __recv_alias(__fd, __buf, __n, __flags);
    if ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8))) != 0)) and !(@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8)))) return __recv_chk_warn(__fd, __buf, __n, sz, __flags);
...
pub inline fn recvfrom(arg___fd: c_int, noalias arg___buf: ?*anyopaque, arg___n: usize, arg___flags: c_int, noalias arg___addr: [*c]struct_sockaddr, noalias arg___addr_len: [*c]socklen_t) isize {
    var __fd = arg___fd;
    var __buf = arg___buf;
    var __n = arg___n;
    var __flags = arg___flags;
    var __addr = arg___addr;
    var __addr_len = arg___addr_len;
    var sz: usize = __builtin_object_size(__buf, @as(c_int, 0));
    if (((__builtin_constant_p(sz) != 0) and (sz == @bitCast(c_ulong, @as(c_long, -@as(c_int, 1))))) or ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8))) != 0)) and (@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8))))) return __recvfrom_alias(__fd, __buf, __n, __flags, __addr, __addr_len);
    if ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8))) != 0)) and !(@bitCast(c_ulong, __n) <= (sz / @sizeOf(u8)))) return __recvfrom_chk_warn(__fd, __buf, __n, sz, __flags, __addr, __addr_len);
...
pub extern fn __recv_chk(__fd: c_int, __buf: ?*anyopaque, __n: usize, __buflen: usize, __flags: c_int) isize;
pub extern fn __recv_alias(__fd: c_int, __buf: ?*anyopaque, __n: usize, __flags: c_int) isize;
pub extern fn __recv_chk_warn(__fd: c_int, __buf: ?*anyopaque, __n: usize, __buflen: usize, __flags: c_int) isize;
pub extern fn __recvfrom_chk(__fd: c_int, noalias __buf: ?*anyopaque, __n: usize, __buflen: usize, __flags: c_int, noalias __addr: [*c]struct_sockaddr, noalias __addr_len: [*c]socklen_t) isize;
pub extern fn __recvfrom_alias(__fd: c_int, noalias __buf: ?*anyopaque, __n: usize, __flags: c_int, noalias __addr: [*c]struct_sockaddr, noalias __addr_len: [*c]socklen_t) isize;
pub extern fn __recvfrom_chk_warn(__fd: c_int, noalias __buf: ?*anyopaque, __n: usize, __buflen: usize, __flags: c_int, noalias __addr: [*c]struct_sockaddr, noalias __addr_len: [*c]socklen_t) isize;
...
pub inline fn vfprintf(arg___stream: [*c]FILE, arg___fmt: [*c]const u8, arg___ap: [*c]struct___va_list_tag) c_int {
    var __stream = arg___stream;
    var __fmt = arg___fmt;
    var __ap = arg___ap;
    return __vfprintf_chk(__stream, @as(c_int, 2) - @as(c_int, 1), __fmt, __ap);
}
pub inline fn vprintf(arg___fmt: [*c]const u8, arg___ap: [*c]struct___va_list_tag) c_int {
    var __fmt = arg___fmt;
    var __ap = arg___ap;
    return __vfprintf_chk(stdout, @as(c_int, 2) - @as(c_int, 1), __fmt, __ap);
} // /usr/include/bits/stdio2.h:44:10: warning: TODO implement function '__builtin___vsprintf_chk' in std.zig.c_builtins
// /usr/include/bits/stdio2.h:41:8: warning: unable to translate function, demoted to extern
pub extern fn vsprintf(arg___s: [*c]u8, arg___fmt: [*c]const u8, arg___ap: [*c]struct___va_list_tag) c_int;
pub extern fn snprintf(__s: [*c]u8, __maxlen: c_ulong, __format: [*c]const u8, ...) c_int; // /usr/include/bits/stdio2.h:68:10: warning: TODO implement function '__builtin___vsnprintf_chk' in std.zig.c_builtins
// /usr/include/bits/stdio2.h:65:8: warning: unable to translate function, demoted to extern
pub extern fn vsnprintf(arg___s: [*c]u8, arg___n: c_ulong, arg___fmt: [*c]const u8, arg___ap: [*c]struct___va_list_tag) c_int;
pub inline fn vdprintf(arg___fd: c_int, noalias arg___fmt: [*c]const u8, arg___ap: [*c]struct___va_list_tag) c_int {
    var __fd = arg___fd;
    var __fmt = arg___fmt;
    var __ap = arg___ap;
...
pub fn getc_unlocked(arg___fp: [*c]FILE) callconv(.C) c_int {
    var __fp = arg___fp;
    return if (__builtin_expect(@bitCast(c_long, @as(c_long, @boolToInt(__fp.*._IO_read_ptr >= __fp.*._IO_read_end))), @bitCast(c_long, @as(c_long, @as(c_int, 0)))) != 0) __uflow(__fp) else @bitCast(c_int, @as(c_uint, @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), blk: {
...
pub fn getchar_unlocked() callconv(.C) c_int {
    return if (__builtin_expect(@bitCast(c_long, @as(c_long, @boolToInt(stdin.*._IO_read_ptr >= stdin.*._IO_read_end))), @bitCast(c_long, @as(c_long, @as(c_int, 0)))) != 0) __uflow(stdin) else @bitCast(c_int, @as(c_uint, @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), blk: {
...
pub inline fn fgets(noalias arg___s: [*c]u8, arg___n: c_int, noalias arg___stream: [*c]FILE) [*c]u8 {
    ...
    var __n = arg___n;
    var __stream = arg___stream;
    var sz: usize = __builtin_object_size(@ptrCast(?*const anyopaque, __s), @boolToInt(@as(c_int, 2) > @as(c_int, 1)));
    if (((__builtin_constant_p(sz) != 0) and (sz == @bitCast(c_ulong, @as(c_long, -@as(c_int, 1))))) or ((((@bitCast(@TypeOf(__n), @as(c_int, 0)) < @bitCast(@TypeOf(__n), -@as(c_int, 1))) or ((__builtin_constant_p(__n) != 0) and (__n > @as(c_int, 0)))) and (__builtin_constant_p(@bitCast(c_ulong, @as(c_long, __n)) <= (sz / @sizeOf(u8))) != 0)) and (@bitCast(c_ulong, @as(c_long, __n)) <= (sz / @sizeOf(u8))))) return __fgets_alias(__s, __n, __stream);
    if ((((@bitCast(@TypeOf(__n), @as(c_int, 0)) < @bitCast(@TypeOf(__n), -@as(c_int, 1))) or ((__builtin_constant_p(__n) != 0) and (__n > @as(c_int, 0)))) and (__builtin_constant_p(@bitCast(c_ulong, @as(c_long, __n)) <= (sz / @sizeOf(u8))) != 0)) and !(@bitCast(c_ulong, @as(c_long, __n)) <= (sz / @sizeOf(u8)))) return __fgets_chk_warn(__s, sz, __n, __stream);
...
pub inline fn fread(arg___ptr: ?*anyopaque, arg___size: c_ulong, arg___n: c_ulong, arg___stream: [*c]FILE) c_ulong {
    ...
    if (((__builtin_constant_p(sz) != 0) and (sz == @bitCast(c_ulong, @as(c_long, -@as(c_int, 1))))) or ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / __size)) != 0)) and (@bitCast(c_ulong, __n) <= (sz / __size)))) return __fread_alias(__ptr, __size, __n, __stream);
    if ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / __size)) != 0)) and !(@bitCast(c_ulong, __n) <= (sz / __size))) return __fread_chk_warn(__ptr, sz, __size, __n, __stream);
...
pub inline fn fread_unlocked(noalias arg___ptr: ?*anyopaque, arg___size: usize, arg___n: usize, noalias arg___stream: [*c]FILE) usize {
    ...
    var __stream = arg___stream;
    var sz: usize = __builtin_object_size(__ptr, @as(c_int, 0));
    if (((__builtin_constant_p(sz) != 0) and (sz == @bitCast(c_ulong, @as(c_long, -@as(c_int, 1))))) or ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / __size)) != 0)) and (@bitCast(c_ulong, __n) <= (sz / __size)))) {
        if ((((__builtin_constant_p(__size) != 0) and (__builtin_constant_p(__n) != 0)) and ((__size | __n) < (@bitCast(usize, @as(c_long, @as(c_int, 1))) << @intCast(@import("std").math.Log2Int(usize), (@bitCast(c_ulong, @as(c_long, @as(c_int, 8))) *% @sizeOf(usize)) / @bitCast(c_ulong, @as(c_long, @as(c_int, 2))))))) and ((__size *% __n) <= @bitCast(c_ulong, @as(c_long, @as(c_int, 8))))) {
            var __cnt: usize = __size *% __n;
            var __cptr: [*c]u8 = @ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __ptr));
            if (__cnt == @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))) return 0;
            while (__cnt > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))) : (__cnt -%= 1) {
                ...
                (blk: {
                    ...
                    ref.* += 1;
                    break :blk tmp;
                }).* = @bitCast(u8, @truncate(i8, __c));
            }
            return @bitCast(c_ulong, @divExact(@bitCast(c_long, @ptrToInt(__cptr) -% @ptrToInt(@ptrCast([*c]u8, @alignCast(@import("std").meta.alignment([*c]u8), __ptr)))), @sizeOf(u8))) / __size;
        }
        return __fread_unlocked_alias(__ptr, __size, __n, __stream);
    }
    if ((((@bitCast(@TypeOf(__n), @as(c_long, @as(c_int, 0))) < @bitCast(@TypeOf(__n), @as(c_long, -@as(c_int, 1)))) or ((__builtin_constant_p(__n) != 0) and (__n > @bitCast(c_ulong, @as(c_long, @as(c_int, 0)))))) and (__builtin_constant_p(@bitCast(c_ulong, __n) <= (sz / __size)) != 0)) and !(@bitCast(c_ulong, __n) <= (sz / __size))) return __fread_unlocked_chk_warn(__ptr, sz, __size, __n, __stream);
...
pub extern fn __vsprintf_chk(noalias __s: [*c]u8, __flag: c_int, __slen: usize, noalias __format: [*c]const u8, __ap: [*c]struct___va_list_tag) c_int;
pub extern fn __snprintf_chk(noalias __s: [*c]u8, __n: usize, __flag: c_int, __slen: usize, noalias __format: [*c]const u8, ...) c_int;
pub extern fn __vsnprintf_chk(noalias __s: [*c]u8, __n: usize, __flag: c_int, __slen: usize, noalias __format: [*c]const u8, __ap: [*c]struct___va_list_tag) c_int;
...
pub extern fn __vfprintf_chk(noalias __stream: [*c]FILE, __flag: c_int, noalias __format: [*c]const u8, __ap: [*c]struct___va_list_tag) c_int;
pub extern fn __vprintf_chk(__flag: c_int, noalias __format: [*c]const u8, __ap: [*c]struct___va_list_tag) c_int;
pub extern fn __dprintf_chk(__fd: c_int, __flag: c_int, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn __vdprintf_chk(__fd: c_int, __flag: c_int, noalias __fmt: [*c]const u8, __arg: [*c]struct___va_list_tag) c_int;
